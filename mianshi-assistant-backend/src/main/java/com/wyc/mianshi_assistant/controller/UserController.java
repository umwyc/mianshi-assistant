...
import com.wyc.mianshi_assistant.config.WxOpenConfig;
...
import com.wyc.mianshi_assistant.model.dto.user.UserAddRequest;
import com.wyc.mianshi_assistant.model.dto.user.UserLoginRequest;
import com.wyc.mianshi_assistant.model.dto.user.UserQueryRequest;
import com.wyc.mianshi_assistant.model.dto.user.UserRegisterRequest;
import com.wyc.mianshi_assistant.model.dto.user.UserUpdateMyRequest;
import com.wyc.mianshi_assistant.model.dto.user.UserUpdateRequest;
import com.wyc.mianshi_assistant.model.entity.User;
import com.wyc.mianshi_assistant.model.vo.LoginUserVO;
...
import static com.wyc.mianshi_assistant.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest
        ...
        try {
            entry = SphU.entry("userRegister", EntryType.IN, 1, remoteAddr);
            // 被保护的逻辑
            if (userRegisterRequest == null) {
                throw new BusinessException(ErrorCode.PARAMS_ERROR, "请输入用户名密码");
            }
            ...
            // 限流逻辑
            return ResultUtils.error(ErrorCode.SYSTEM_ERROR, "注册过于频繁，请稍一分钟后再试");
        } finally {
            if (entry != null) {
    ...
    public BaseResponse<LoginUserVO> userLogin(@RequestBody UserLoginRequest userLoginRequest
        ...
        try {
            ...
            // 限流逻辑
            return ResultUtils.error(ErrorCode.SYSTEM_ERROR, "登录过于频繁，请稍一分钟后再试");
        } finally {
            if (entry != null) {
                entry.exit(1, remoteAddr);
            }
